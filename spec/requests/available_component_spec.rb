...
RSpec.describe 'Available Types', type: :request do
  ...
  context 'Get /api/v1/available_types' do
    it 'Returns a list of available component types' do

      NUMBER_TO_CREATE = 5

      FactoryBot.create_list :available_component, NUMBER_TO_CREATE
      ...
      NUMBER_TO_CREATE.times do |i|
        ...
        CheckListEngine::AvailableComponent.find_by_title title['attributes']['title']
      end
